...
<head>
    ...
    <link href="styles/projektkomponenten.css" rel="stylesheet">
...
<div class="container">
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Servomotoren.png" alt="Servomotoren" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Rasperry.png" alt="Raspberry Pi 4" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Motoren.png" alt="Motoren" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/SSD.png" alt="SSD (32GB)" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Reifen.png" alt="Reifen" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Step-Down_Modul.png" alt="Step-down Modul" class="img-fluid no-select">
    </div>
    ...
    <div class="component fade-in zoom no-select">
        ...
        <img src="imagesAuto/Sensoren.png" alt="Ultraschallsensor" class="img-fluid no-select">
    </div>
</div>
